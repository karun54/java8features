...
public class collectionscomparatoeexample1 {
	...
	public static void main(String[] args) {
		List<Employee1> employees=new ArrayList<>(); 
	     ...
	     Collections.sort(employees, sortComp);
	     employees.forEach(p1->System.out.println(p1.getId()+" "+p1.getSalary()+" "+p1.getName()+" "+p1.getAge()));
...
/*public static <T, U extends Comparable<? super U>> Comparator<T> comparing(Function<? super T, ? extends U> keyExtractor)
   {
	...
	private static Comparator<Employee1> getSortComp(String sortBy) {
		...
		{
		case "empId":
			 return Comparator.comparing(Employee1::getId);//comparator.comparing(keyextractor)//this keyextractor is going to return the objects field value 
		case "age":
			 return Comparator.comparing(Employee1::getAge);
		case "name":
